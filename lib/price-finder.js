          ...
          .end((err, response) => {
            ...
            if (response) {
              if (response.statusCode === 200) {
                ...
                this._config.retryStatusCodes.indexOf(response.statusCode) > -1
              ) {
...
const uri =
  "https://www.amazon.es/Corsair-M65-Elite-%C3%93ptico-Retroiluminaci%C3%B3n/dp/B07KM9MBFD/ref=sr_1_1_sspa?__mk_es_ES=%C3%85M%C3%85%C5%BD%C3%95%C3%91&crid=2YAIMYEXPM3FK&dchild=1&keywords=corsair%2Bm65%2Belite&qid=1608873987&s=computers&sprefix=corsair%2Bm65%2Ccomputers%2C226&sr=1-1-spons&spLa=ZW5jcnlwdGVkUXVhbGlmaWVyPUFHT09QUVVWVEpCTjImZW5jcnlwdGVkSWQ9QTA5NzU5NDMxR0tHNVkzNTFRSksmZW5jcnlwdGVkQWRJZD1BMDIyNjU4N1gyUFE2OFpRRjBGNCZ3aWRnZXROYW1lPXNwX2F0ZiZhY3Rpb249Y2xpY2tSZWRpcmVjdCZkb05vdExvZ0NsaWNrPXRydWU&th=1";
